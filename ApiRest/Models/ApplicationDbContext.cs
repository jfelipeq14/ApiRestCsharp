...
public partial class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DetallePaqueteServicio>(entity =>
        {
            ...
            entity.HasOne(d => d.IdPaqueteNavigation).WithMany(p => p.DetallePaqueteServicios)
                .HasForeignKey(d => d.IdPaquete)
                .HasConstraintName("FK_idPackage");

            entity.HasOne(d => d.IdServicioNavigation).WithMany(p => p.DetallePaqueteServicios)
        ...
        modelBuilder.Entity<DetalleReservaViajero>(entity =>
        {
            ...
            entity.HasOne(d => d.IdClienteNavigation).WithMany(p => p.DetalleReservaViajeros)
                .HasForeignKey(d => d.IdCliente)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_idClienteReservaViajero");

            entity.HasOne(d => d.IdReservaNavigation).WithMany(p => p.DetalleReservaViajeros)
        ...
        modelBuilder.Entity<Paquete>(entity =>
        {
            ...
            entity.HasOne(d => d.IdActividadNavigation).WithMany(p => p.Paquetes)
                .HasForeignKey(d => d.IdActividad)
                .HasConstraintName("FK_idActividadPaquete");

            entity.HasOne(d => d.IdMunicipioNavigation).WithMany(p => p.Paquetes)
                .HasForeignKey(d => d.IdMunicipio)
        ...
        modelBuilder.Entity<Privilegio>(entity =>
        {
            ...
            entity.HasOne(d => d.IdPermisoNavigation).WithMany(p => p.Privilegios)
        ...
        modelBuilder.Entity<Reserva>(entity =>
        {
            ...
            entity.HasOne(d => d.IdProgramacionNavigation).WithMany(p => p.Reservas)
        ...
        modelBuilder.Entity<RolPrivilegio>(entity =>
        {
            ...
            entity.HasOne(d => d.IdPrivilegioNavigation).WithMany(p => p.RolPrivilegios)
                .HasForeignKey(d => d.IdPrivilegio)
                .HasConstraintName("FK_idPrivilegio");

            entity.HasOne(d => d.IdRolNavigation).WithMany(p => p.RolPrivilegios)
